...
class SponsorUser(db.Model):
    ...
    sponsor_logo = db.Column(db.String(20), unique= False, nullable= True, default = 'default.jpeg' )# check on the nullable field
    sponsor_latitude = db.Column(db.Float(precision=12,scale=7), nullable = False)
    sponsor_longitude = db.Column(db.Float(precision= 12,scale =7), nullable = False)
    def __repr__(self):
