...
<img src="https://github.com/nidheekamble/SponsCentral/blob/master/SponsCentral/static/SponsCentral_demo.gif" width=1000>
<hr>
...
To see the working model of the project, please visit the page:<br>
...
Mentor: Ameya Daddikar (AmeyaDaddikar).<br>
